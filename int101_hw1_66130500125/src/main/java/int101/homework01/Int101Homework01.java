...
public class Int101Homework01 {
    ...
    static void work01Question(boolean b1, boolean b2, boolean b3, boolean b4, boolean b5, boolean b6) {
       // do nothing in this method; do your work in Answer01Question()
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
      double weight = 70.0;
      double height = 1.7;
      System.out.println("BMI = "+ MyUtil.calculteBmi(weight, height));
   ...
   static void work04UseOfObjectClass() {
      ...
      4.2 Create a public class named "BankAccount" in package named "work04".
          ...
          4.2.8 @Override a public "toString" method that 
                returns a "String" of value "BankAccount(id,number)" 
                where "id" is the "id" field.
      ...
      */
      ...
      BankAccount acc1 = new BankAccount(111,p1);
      BankAccount acc2 = new BankAccount(222,p2);
      
      // Before deposit
       System.out.println("Before deposit current balance = "+acc1.getBalance());
       //After deposit
       System.out.println("After deposit 500 current balance = "+acc1.deposit(500));
       
       // try withdraw
       System.out.println("Before withdraw current balance = "+acc1.getBalance());
       System.out.println("After withdraw 200 current balance = "+acc1.withdraw(200));
       
       //Before tranfer
       System.out.println("acc1 current balance = "+acc1.getBalance());
       System.out.println("acc2 current balance = "+acc2.getBalance());
       //tranfer
       acc1.tranfer(100, acc2);
       System.out.println("acc1 is tranfer to acc2 100 ");
       //After tranfer
       System.out.println("acc1 current balance = "+acc1.getBalance());
       System.out.println("acc2 current balance = "+acc2.getBalance());
